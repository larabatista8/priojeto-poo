...
public class AppView {
	 private Scanner scanner;
	    ...
	    public int exibirMenuAdmin() {
	        ...
	        System.out.println("4. Adicionar DVD");
	        System.out.println("5. Adicionar Documentário");
	        System.out.println("6. Adicionar Áudio-Livro");
	        System.out.println("7. Adicionar Podcast");
	        System.out.println("8. Listar Livros");
	        System.out.println("9. Listar Jornais");
	        System.out.println("10. Listar CDs");
	        System.out.println("11. Listar DVDs");
	        System.out.println("12. Listar Documentários");
	        System.out.println("13. Listar Áudio-Livros");
	        System.out.println("14. Listar Podcasts");
	        System.out.println("15. Remover Livro");
	        System.out.println("16. Remover Jornal");
	        System.out.println("17. Remover CD");
	        System.out.println("18. Remover DVD");
	        System.out.println("19. Remover Documentário");
	        System.out.println("20. Remover Áudio-Livro");
	        System.out.println("21. Remover Podcast");
	    ...
	    public int exibirMenuUsuario() {
	        ...
	        System.out.println("======================================");
	        System.out.println("1. Consultar Obras Disponíveis");
